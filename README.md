...
const web3 = new Web3(NET.TEST) // const web3 = new Web3(NET.MAIN);

// Get the balance of an address
const balance = await web3.addr.getBalance('dwm1ycvfsa6d3vsrzne5nqyw420qtp8krxvbmddck8tyqqzvtamp9p8y54:sm2')
